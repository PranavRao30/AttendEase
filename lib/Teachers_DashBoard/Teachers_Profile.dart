...
// import 'packrebase_auth/firebase_auth.dart';
...
// class Teachers_Profile extends StatelessWidget {
...
// class Teacher_Profile_Page extends StatefulWidget {
//   const Teacher_Profile_Page({Key? key}) : super(key: key);

//   @override
//   _TeacherProfilePageState createState() => _TeacherProfilePageState();
// }

// class _TeacherProfilePageState extends State<Teacher_Profile_Page> {
...
void main() {
  runApp(const Teachers_Table());
}

class Teachers_Table extends StatelessWidget {
  const Teachers_Table({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Teacher_Table_Page(),
    );
  }
}

class Teacher_Table_Page extends StatefulWidget {
  const Teacher_Table_Page({Key? key}) : super(key: key);

  @override
  _TeacherTablePageState createState() => _TeacherTablePageState();
}

class _TeacherTablePageState extends State<Teacher_Table_Page> {
  List<get_table1> _data = List.from(Students_data);
  bool is_sort = true;
  Widget buildTable() {
